...
const Login = () => {
    const{UserLogin,gooogleSingUp,Gitsignin,setUser,user}=useContext(AuthContext)
        ...
        return (
                ...
                <form onSubmit={signIn} className="space-y-6">
                    ...
                    <div className="space-y-2 text-sm">
                       ...
                       <input type={update} name="password" id="password" placeholder="Password" className="w-full px-4 py-3 rounded-md border border-indigo-300 focus:outline-none focus:ring  "  />
                ...
                <div className="flex justify-center space-x-4">
                    <button onClick={googleHandle} aria-label="Log in with Google" className="p-3 rounded-full hover:bg-gray-200">
                    ...
                    <button onClick={gitHandle} aria-label="Log in with GitHub" className="p-3 rounded-full hover:bg-gray-200">
